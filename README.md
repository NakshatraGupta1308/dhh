...
| `hustle.json` | show (about, format, streaming, production, spinoffs) and seasons (titles, dates, status, about, hosts, judges, squad_bosses, guests with role, week and artist_ids, prize, highlights, contestants with real_name, squad, result, place, finish, og_hustler, artist_id, plus `sections` and `weeks` made of text, heading and table blocks) |
