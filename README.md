...
| `hustle.json` | show (about, format, streaming, spinoffs) and seasons (number, titles, dates, status, hosts, judges, squad_bosses, guests, prize, highlights, roster_complete, contestants with real_name, from, squad, result, artist_id) |
