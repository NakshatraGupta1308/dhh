...
The current seed is a hand-built first pass: 35 artists, 82 releases, 12 labels and crews, and 13 scenes. Treat anything marked `medium` or `low` as needing verification before a public launch. Haryana, the Northeast and more producers are the obvious gaps to fill next.
